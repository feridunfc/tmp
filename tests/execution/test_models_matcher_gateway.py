...
def test_market_fills_at_open():
    ...
    f = match_order_on_bar(od, o=100, h=101, l=99, c=100)
...
def test_stop_limit_requires_both_conditions():
    ...
    # hem stop tetikler hem limit çaprazlanırsa fill
    f2 = match_order_on_bar(od, o=100, h=101, l=99.0, c=100)
